<template>
  <div
      :class="[
      'transition-200 h-10 inline-flex items-center justify-start relative bg rounded-lg border border-gray-200 overflow-hidden w-full p-2.5 px-3 ',
      error
  ...
  >
    ...
    <input
        ...
        :class="[
        inputClass,
        'font-normal text-sm leading-130 placeholder:capitalize text-gray-300 placeholder:text-gray bg-transparent grow outline-hidden  !outline-none',
      ]"
        class="w-full "
        ref="kInput"
        @input="handleInput"
